...
## Download the three datasets you have access to on the UMN SQL server.

# Save them as employees_tbl, testscores_tbl, and offices_tbl
# Save them as employees.csv, testscores.csv., and offices.csv 

# Create a dataset called week13_tbl combining the data such that employees without test scores are removed. 
# You must do this with joins only. 
# Save this file as week13.csv (you can place this in out).



# Analysis
## using SQL calls alone, using data consisting only of employees that have test scores:
